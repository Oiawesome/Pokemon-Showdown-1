...
var commands = exports.commands = {
	...
	tiers: function(target, room, user) {
		...
		if (target === 'nollansfactoryseasonal' || target === 'nollanservseasonal') {
            		matched = true;
            		this.sendReplyBox('The Nollan\'s Factory seasonal is based on Joim\'s monthly seasonal tiers. It is for the seasons only, however, and as such it will tend to have more changes and will last longer.');
		}
		...
		if (target === 'npmou' || target === 'npmubers' || target === 'npm') {
            		...
            		this.sendReplyBox('NPM is a pokemon mod that aims to value flavor more than most other mods. In addition, it explores new typings, and how new abilities and moves affect the OU metagame.<br />' +
            			'- <a href="http://pastebin.com/5Duu4WfH" target="_blank">Current NPM changelist</a><br />' +
		...
		if (target === 'v2' || target === 'v2project' || target === 'nuv2' || target === 'ruv2' || target === 'uuv2' || target === 'ouv2') {
            		matched = true;
            		this.sendReplyBox('- <a href="http://piratepad.net/v2ProjectRevamption" target="_blank">Current v2 Revamption Changelist</a><br />');
		}
